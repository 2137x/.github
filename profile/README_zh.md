...
| 项目 | 主页 | 里面有什么 |
| --- | --- | --- |
| 🏢 **组织默认配置** | [`.github`](https://github.com/travnie/.github) | 组织主页、社区文件、主页同步和组织级基础设施 |
| 🚗 **Autka** | [`travnie/Autka`](https://github.com/travnie/Autka) | Android/KMP 汽车信息聚合器及后端 |
| 🤖 **LlmBench** | [`travnie/llmbench`](https://github.com/travnie/llmbench) | 用于通过账户和免费提供商访问 LLM 的 Android 工作区 |
| 🐤 **Kanarek** | [`travnie/kanarek`](https://github.com/travnie/kanarek) | RSS/Atom 阅读器、小组件、广播/IPTV 和 Worker 后端 |
...
| 🔊 **WAM Bridge** | [`travnie/wambridge`](https://github.com/travnie/wambridge) | Samsung Wireless Audio Multiroom 桥接器和 foobar2000 输出 |
| 🧰 **工作台** | [`travnie/twojstar`](https://github.com/travnie/twojstar) | Benches、Weather Feed、Feedboard、Xiaomi ADB Tools、Paint.NET ICO 和统一滚动发布 |
...
| 仓库 | PR | 标题 | 作者 | 状态 | 更新 |
| --- | ---: | --- | --- | --- | --- |
| travnie/llmbench | [#181](https://github.com/travnie/llmbench/pull/181) | Rename LlmBench to Aistee | @trvny | 就绪 | 2026-09-13 |
| travnie/twojstar | [#126](https://github.com/travnie/twojstar/pull/126) | feat(docbench): allow editing the filename | @trvny | 就绪 | 2026-09-13 |
<!--OPEN_PRS:END-->
